...
export default async function Page({ searchParams }: Props) {
  ...
  const parsed = {
    rinkType:
      params.rinkType === "INDOOR" || params.rinkType === "OUTDOOR" ? params.rinkType as IceRinkType : undefined,
    hasSchedule: typeof params.hasSchedule === "string" ? !!params.hasSchedule : undefined,
    metroIds:
      typeof params.metroIds === "string"
        ? params.metroIds
          .split(",")
        ...
        : undefined,
    districts:
      typeof params.districts === "string"
        ? params.districts
          .split(",")
          .filter((d): d is District => Object.values(District).includes(d as District))
        : undefined,
    sessionTypes:
      typeof params.sessionTypes === "string" ? params.sessionTypes.split(",") : undefined,
  }
